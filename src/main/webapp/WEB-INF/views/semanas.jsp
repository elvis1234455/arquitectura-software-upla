...
<head>
    ...
    <title>Semanas — EduPlatform</title>
...
<div class="main-content" id="mainContent">
    ...
    <div class="page-content">
        ...
        <c:if test="${not empty error}">
            <div class="toast toast-error" id="toastMsg"><i class="fas fa-times-circle"></i> ${error}</div>
        </c:if>

        <div class="section-header">
            <div><h2>Semanas del Curso</h2><p>Selecciona una semana para ver sus materiales.</p></div>
    ...
    <div class="modal">
        ...
        <form action="${pageContext.request.contextPath}/semanas" method="post">
            ...
            <div class="modal-body">
                <div class="form-group"><label>Número <span class="required">*</span></label><input type="number" name="numero" min="1" max="20" required class="form-input" placeholder="Ej: 1"></div>
                <div class="form-group"><label>Título <span class="required">*</span></label><input type="text" name="titulo" required class="form-input" maxlength="200" placeholder="Ej: Introducción al curso"></div>
                ...
                <div class="form-group"><label>Contenido detallado</label><textarea name="contenido" rows="3" class="form-textarea" placeholder="Temas, subtemas..."></textarea></div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn-secondary" onclick="cerrarModal('modalCrear')">Cancelar</button>
                <button type="submit" class="btn-primary"><i class="fas fa-save"></i> Crear Semana</button>
            </div>
        </form>
    </div>
</div>
    ...
    <div class="modal modal-sm">
        ...
        <form action="${pageContext.request.contextPath}/semanas" method="post">
            ...
            <div class="modal-body">
                ...
                <p class="text-danger"><i class="fas fa-exclamation-circle"></i> Se eliminarán todos sus materiales de Supabase Storage. Esta acción no se puede deshacer.</p>
            </div>
            <div class="modal-footer">
